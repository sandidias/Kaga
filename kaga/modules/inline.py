...
from kaga.modules.nhentai import nhentai, nhentai_data
from kaga.modules.anilist import url, anime_query, manga_query, shorten, airing_query, character_query
...
from kaga.utils.aiohttp_class import AioHttp

from kaga.utils.errors import capture_err
            

@kagabot.on_inline_query()
@capture_err

...
@kagabot.on_message(filters.user(ALLOWED_USERS) & filters.command("eval"))
@capture_err
...
@kagabot.on_message(filters.user(ALLOWED_USERS) & filters.command("term"))
@capture_err
...
async def chat_stats(client, message):
    ...
    for chat in all_chats:
        ...
        bot_member = await curr_chat.get_member(1389308739)

...
import requests
from kaga import TIME_API_KEY, dispatcher
...
def gettime(update, context):
    ...
    try:
        ...
        message.reply_text(
            "Berikan nama negara/singkatan/zona waktu untuk ditemukan.")
        return
...
*Pertanyaan yang tersedia: * Kode Negara/Nama Negara/Nama Zona Waktu

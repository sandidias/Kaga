...
@kagabot.on_message(~filters.me & filters.command('airinfo', prefixes='/'), group=8)
@capture_err
...
@kagabot.on_message(~filters.me & filters.command('animeinfo', prefixes='/'), group=8)
@capture_err
...
@kagabot.on_message(~filters.me & filters.command('charinfo', prefixes='/'), group=8)
@capture_err
...
@kagabot.on_message(~filters.me & filters.command('mangainfo', prefixes='/'), group=8)
@capture_err

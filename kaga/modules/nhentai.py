...
from kaga import kagabot, telegraph

from kaga.utils.errors import capture_err


@kagabot.on_message(~filters.me & filters.command('nhentai', prefixes='/'), group=8)
@capture_err
...
@kagabot.on_inline_query(filters.regex(r'^nhentai (\d+)$'))
@capture_err
